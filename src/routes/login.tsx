    ...
    <div className="flex min-h-screen flex-col bg-background">
      <main className="relative flex-1">
        ...
        <div className="surface-navy relative h-[46vh] min-h-[260px] w-full md:h-[52vh]">
          <div className="mx-auto flex h-full max-w-6xl items-center justify-between px-6 pt-10 md:pt-14">
            <Link to="/" aria-label="Apex Digital Bank home" className="self-start">
              <ApexLogo
            ...
            <Link
              to="/signup"
              className="self-start rounded-lg border border-navy-foreground/30 px-4 py-2 text-sm font-medium text-navy-foreground transition-colors hover:bg-navy-foreground/10"
            >
              Open an account
            </Link>
          </div>
